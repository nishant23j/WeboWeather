...
public interface Field {
    ...
    public static String BASE_URL="http://www.nishant23j.hol.es";
    public static String URL_FETCH_DATA="weboweather/getImage.php";
    public static String URL_UPLOAD="VolleyUpload/upload.php";
